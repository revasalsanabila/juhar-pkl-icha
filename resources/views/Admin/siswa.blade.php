                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.pembimbing.siswa.delete', ['id' => $id, 'id_siswa' => $siswa->id_siswa]) }}" onclick="return confirm('Yakin anda ingin menghapus data?')" class=" btn-danger btn-sm">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
